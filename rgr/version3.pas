PROGRAM Version3(INPUT, OUTPUT);   {слияние дерева и прошлой версии, выстраивает слова друг под другом по размеру, не обрабатывает то, что после странных символов и пробелов(2+)}
